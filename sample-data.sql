...
('E-commerce Platform', 'Full-featured online shopping experience', '/uploads/sample-project-3.jpg'),
('Brand Identity', 'Complete branding package including logo and guidelines', '/uploads/sample-project-4.jpg'),
...
('Michael Brown', 'Their attention to detail is outstanding. Great experience!', 'Founder, StartupXYZ', '/uploads/sample-client-3.jpg'),
('Emily Davis', 'Transformed our brand completely. Amazing results!', 'Product Manager', '/uploads/sample-client-4.jpg'),
('David Wilson', 'Best decision we made for our digital presence.', 'CTO, Innovation Labs', '/uploads/sample-client-5.jpg'),
('Lisa Anderson', 'Creative solutions and excellent communication throughout.', 'Business Owner', '/uploads/sample-client-6.jpg');
